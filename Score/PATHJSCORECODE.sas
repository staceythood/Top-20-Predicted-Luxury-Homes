...
* NODE: MdlComp;
*------------------------------------------------------------*;
if (P_Sale_Price ge 290434.599194917) then do;
b_Sale_Price = 1;
end;
else
if (P_Sale_Price ge 253893.489065465) then do;
b_Sale_Price = 2;
end;
else
if (P_Sale_Price ge 231053.117969006) then do;
b_Sale_Price = 3;
end;
else
if (P_Sale_Price ge 213022.787227629) then do;
b_Sale_Price = 4;
end;
else
if (P_Sale_Price ge 201715.601363484) then do;
b_Sale_Price = 5;
end;
else
if (P_Sale_Price ge 190198.819037389) then do;
b_Sale_Price = 6;
end;
else
if (P_Sale_Price ge 181486.532168988) then do;
b_Sale_Price = 7;
end;
else
if (P_Sale_Price ge 173006.18492461) then do;
b_Sale_Price = 8;
end;
else
if (P_Sale_Price ge 164550.546166346) then do;
b_Sale_Price = 9;
end;
else
if (P_Sale_Price ge 158632.932883038) then do;
b_Sale_Price = 10;
end;
else
if (P_Sale_Price ge 151823.015291462) then do;
b_Sale_Price = 11;
end;
else
if (P_Sale_Price ge 146005.925494325) then do;
b_Sale_Price = 12;
end;
else
if (P_Sale_Price ge 140529.896786696) then do;
b_Sale_Price = 13;
end;
else
if (P_Sale_Price ge 135232.921431337) then do;
b_Sale_Price = 14;
end;
else
if (P_Sale_Price ge 129277.149150921) then do;
b_Sale_Price = 15;
end;
else
if (P_Sale_Price ge 124058.866144338) then do;
b_Sale_Price = 16;
end;
else
if (P_Sale_Price ge 118061.656800756) then do;
b_Sale_Price = 17;
end;
else
if (P_Sale_Price ge 110294.011662345) then do;
b_Sale_Price = 18;
end;
else
if (P_Sale_Price ge 100668.109026568) then do;
b_Sale_Price = 19;
end;
else
do;
