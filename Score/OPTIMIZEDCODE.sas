...
* Encoding: wlatin1;
* Locale: en_US;
* Project Path: C:\Users\guerryhood\Documents\SASEMProjects;
* Project Name: Final Project;
* Diagram Id: EMWS1;
* Diagram Name: Final Project;
* Generated by: guerryhood;
* Date: 30NOV2020:14:11:18;
*------------------------------------------------------------*;
*------------------------------------------------------------*;
...
EM_SEGMENT = b_Sale_Price;
LABEL EM_PREDICTION= "Prediction for Sale_Price";
EM_PREDICTION = P_Sale_Price;
